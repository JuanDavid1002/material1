            ...
            <form class="needs-validation " novalidate>
              <div class="form-row">
                <div class="container">
                  ...
                  <br>
                  <div align="center">
                    <label for="nombre">Seleccione una referencia de motos de automaticas:</label>
                    <br>
                    <div class="dropdown">
                      <select name="txtclasificacionmotos2" class="btn btn-warning dropdown-toggle" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" type="button" name="txtclasificacionmotos1">
                        <option name="idclasificaciondemotos" value="">Seleccione:</option>
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                          <?php

                          $query = $conn->query("SELECT * FROM tab_motos_automaticas");
                          while ($valores = mysqli_fetch_array($query)) {
                            echo '<option value="' . $valores[1] . '">' . $valores[1] . '</option>';
                          }
                          ?>
                    ...
                    <div class="form-group">
                      <label for="nombre">Cantidad de preventa de Motos Automaticas:</label>
                  ...
                  <a href="/material1/proyecto_principal/info_motos_vendedor/info_automatica_acces125fi.php" class="btn btn-warning"><b>Atras</b></a>
                </form>
        </div>
  </center>
</body>
