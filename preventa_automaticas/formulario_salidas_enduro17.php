            ...
            <form class="needs-validation " novalidate>
              <div class="form-row">
                <div class="container">
                  ...
                  <br>
                  <div align="center">
                    <label for="nombre">Seleccione una referencia de motos de Enduro:</label>
                    <br>
                    <div class="dropdown">
                      <select name="txtclasificacionmotos2" class="btn btn-warning dropdown-toggle" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" type="button" name="txtclasificacionmotos2">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                          ...
                          $query = $conn->query("SELECT * FROM tab_motos_enduro");
                          while ($valores = mysqli_fetch_array($query)) {
                            echo '<option value="' . $valores[1] . '">' . $valores[1] . '</option>';
                          }
                          ?>
                    ...
                    <div class="form-group">
                      <label for="nombre">Cantidad de preventa de Motos Enduro:</label>
                  ...
                  <a href="/material1/proyecto_principal/info_motos_vendedor/info_enduro_dr150.php" class="btn btn-warning"><b>Atras</b></a>
                </form>
        </div>
  </center>
</body>
