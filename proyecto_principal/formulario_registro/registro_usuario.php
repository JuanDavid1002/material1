...
$stmt = $conn->prepare("CALL ingresar_usuarios (?,?,?,?,?,?,?,?,?,?,?,?,?)");
$stmt->bind_param("sssisisssssss", $nombres,$apellidos,$genero,$cargo,$tipodocumento,$numerodocumento,$direccion,$telefono,
$ciudad,$correo,$nombreusuario,$observaciones,$otro);
...
<center>
<a href="formulario_registro_usuarios.html" class="btn btn-success btn-lg">Nuevo Registro</a>
<a href="http://localhost/material1/template.php" class="btn btn-success btn-lg">Regresar</a>
