...
$result1= $conn->query($sql1);
  ...
  while($row = $result1->fetch_assoc()) {
   $resultado1=$row["referencia_enduro"];
   $resultadob=$row["color_enduro"];
   $resultado3=$row["modelo_enduro"];
   $resultado4=$row["precio"];
   $resultado5=$row["cilindraje_enduro"];
   $resultado6=$row["transmision_enduro"];
   $resultado7=$row["motor_enduro"];
   $resultado8=$row["capacidad_tanque_combustible_enduro"];
      ...
      <div class="row mt-4">
        <div class="col">
          <div class="card">
            ...
            <img class="w-75 mt-n7 mt-lg-n8 d-none d-md-block mx-auto z-index-1" src="img/Enduro/DR150.png"
              alt="car image">
            ...
            <a href="/material1/preventa_automaticas/formulario_salidas_enduro17.php" class="btn-success" >Precompra</a>
            <a href="/material1/proyecto_principal/vendedor_desplegable_motos/enduro.php" class="btn btn-info"><b>Atras</b></a>
          </div>
        </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-4 text-end">
                      <img class="w-50" src="https://seeklogo.com/images/S/Suzuki-logo-1298046A2E-seeklogo.com.png"
                        alt="image sun">
                      <h4 class="mb-0 text-white text-end me-1">Enduro</h4>
                    </div>
                  </div>
                </div>
              </div>
