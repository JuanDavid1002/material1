...
$simbolo='$';
$sql1 = "SELECT   referencia_cruiser,
                  color_cruiser,
                  modelo_cruiser,
                  precio,
                  cilindraje_cruiser,
                  motor_cruiser,
                  capacidad_tanque_combustible_cruiser,
                  totalmotos
 FROM tab_motos_cruiser WHERE referencia_cruiser='intruder'";
$result1= $conn->query($sql1);
               if ($result1->num_rows > 0) {
  while($row = $result1->fetch_assoc()) {
   $resultado1=$row["referencia_cruiser"];
   $resultadob=$row["color_cruiser"];
   $resultado3=$row["modelo_cruiser"];
   $resultado4=$row["precio"];
   $resultado5=$row["cilindraje_cruiser"];
   $resultado6=$row["motor_cruiser"];
   $resultado7=$row["capacidad_tanque_combustible_cruiser"];
      ...
      <div class="row mt-4">
        <div class="col">
          <div class="card">
            ...
            <img class="w-75 mt-n7 mt-lg-n8 d-none d-md-block mx-auto z-index-1" src="img/Cruiser/INTRUDER  GRIS.png"
              alt="car image">
            ...
            <a href="/material1/preventa_automaticas/formulario_salidas_cruiser18.php" class="btn-success" >Precompra</a>
            <a href="/material1/proyecto_principal/vendedor_desplegable_motos/cruiser.php" class="btn btn-info"><b>Atras</b></a>
          </div>
        </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-4 text-end">
                      <img class="w-50" src="https://seeklogo.com/images/S/Suzuki-logo-1298046A2E-seeklogo.com.png"
                        alt="image sun">
                      <h4 class="mb-0 text-white text-end me-1">cruiser</h4>
                    </div>
                  </div>
                </div>
              </div>
