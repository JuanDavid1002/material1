...
$simbolo='$';
$sql1 = "SELECT   referencia_automaticas,
                  color_automaticas,
                  modelo_automaticas,
                  precio,
...
$result1= $conn->query($sql1);
  ...
  while($row = $result1->fetch_assoc()) {
   $resultado1=$row["referencia_automaticas"];
   $resultadob=$row["color_automaticas"];
   $resultado3=$row["modelo_automaticas"];
   $resultado4=$row["precio"];
   $resultado5=$row["cilindraje_automaticas"];
   $resultado6=$row["transmision_automaticas"];
   $resultado7=$row["motor_automaticas"];
   $resultado8=$row["capacidad_tanque_automaticas"];
...
<head>
  ...
  <title><?php echo $resultado1;?></title>
      ...
      <div class="row mt-4">
        <div class="col">
          <div class="card">
            ...
            <img class="w-75 mt-n7 mt-lg-n8 d-none d-md-block mx-auto z-index-1" src="img/Automaticas/ACCESS 125 FI.png"
              alt="car image">
            ...
            <a href="/material1/preventa_automaticas/formulario_salidas_automaticas1.php" class="btn-success" >Precompra</a>
            <a href="/material1/proyecto_principal/vendedor_desplegable_motos/automaticas.php" class="btn btn-info"><b>Atras</b></a>
          </div>
        </div>
