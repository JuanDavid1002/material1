...
$actualizar = "UPDATE tab_motos_sport SET referencia_sport='$referencia',
color_sport='$color',modelo_sport='$modelo', marca_sport='$marca',
cantidad_sport='$cantidad',precio='$precio', idclasificaciondemotos='$idclasificaciondemotos' WHERE idmotossport='$id'";
...
class="col-md-6">
          <div class="card">
            <div class="card-header card-header-text card-header-warning">
              <div class="card-text">
                <h4 class="card-title">Registro Motos sport</h4>
              </div>
            </div>
	<?php
