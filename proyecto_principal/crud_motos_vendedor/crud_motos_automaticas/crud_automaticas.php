...
$sql = "SELECT idmotosautomaticas,referencia_automaticas,color_automaticas,modelo_automaticas,marca_automaticas,totalmotos,precio,idclasificaciondemotos FROM tab_motos_automaticas ORDER BY idmotosautomaticas";
                    ...
                    <tr>
                      ...
                      <td class="td-actions text-right">
                        ...
                        <button type="button" class="btn btn-success btn-round" data-toggle="modal" data-target="#staticBackdrop">
                          <a class="td-actions text-right" href="editar.php?id=<?php echo $row["idmotosautomaticas"]; ?>"><i class="material-icons">edit</i></a>
                        </button>
