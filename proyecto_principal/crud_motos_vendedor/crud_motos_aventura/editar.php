                ...
                <form class="needs-validation " novalidate>
                  <div class="form-row">
                    <div class="container">
                      ...
                      <a href="/material1/proyecto_principal/crud_motos_vendedor/crud_motos_aventura/crud_aventura.php" class="btn btn-warning " role="button" aria-pressed="true">Regresar</a>
                </form>
            <?php
          }
        }
