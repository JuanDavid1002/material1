...
$sql = "SELECT idmotos_alto_cilindraje,referencia_alto_cilindraje,color_alto_cilindraje,modelo_alto_cilindraje,marca_alto_cilindraje,cantidad_alto_cilindraje,precio,idclasificaciondemotos FROM tab_motos_semiautomaticas ORDER BY idmotossemiautomaticas";
                ...
                ?>
                  <tbody>
                    <tr>
                      ...
                      <td><?php echo  $row["cantidad_semiautomaticas"]; ?> </td>
