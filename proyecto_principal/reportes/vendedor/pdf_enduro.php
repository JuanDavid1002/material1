...
$pdf->Cell(32,10,'Vendidas',1,1,'C');
 ...
 while ($row = $result->fetch_assoc()) {
    ...
    $pdf->Cell(32,10, $row["referencia_enduro"],1,0,'C',0);
    $pdf->Cell(32,10, $row["color_enduro"],1,0,'C',0);
    $pdf->Cell(32,10, $row["modelo_enduro"],1,0,'C',0);
    $pdf->Cell(32,10, $row["marca_enduro"],1,0,'C',0);
...
$consulta1 = "SELECT SUM(totalmotos) FROM tab_motos_enduro";
...
$consulta1 = "SELECT SUM(salidamotos) FROM tab_motos_enduro";
if ($resultado = $conn->query($consulta1)) {
while ($fila = $resultado->fetch_row()) {
    $fila[0]; 
     //color del texto titulos color negro
