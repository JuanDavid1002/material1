...
$pdf->Ln(10);
$pdf->Ln(30);
$pdf->Image('img/logo.png',60,30,90);
$pdf->Ln(20);
...
$pdf->Cell(32,10,'Vendidas',1,1,'C');
 ...
 while ($row = $result->fetch_assoc()) {
    ...
    $pdf->Cell(32,10, $row["referencia_sport"],1,0,'C',0);
    $pdf->Cell(32,10, $row["color_sport"],1,0,'C',0);
    $pdf->Cell(32,10, $row["modelo_sport"],1,0,'C',0);
    $pdf->Cell(32,10, $row["marca_sport"],1,0,'C',0);
...
$consulta1 = "SELECT SUM(totalmotos) FROM tab_motos_sport";
...
$consulta1 = "SELECT SUM(salidamotos) FROM tab_motos_sport";
if ($resultado = $conn->query($consulta1)) {
while ($fila = $resultado->fetch_row()) {
    $fila[0]; 
     //color del texto titulos color negro
