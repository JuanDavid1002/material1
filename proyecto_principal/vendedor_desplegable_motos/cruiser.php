...
$simbolo='$';
$sql1 = "SELECT referencia_cruiser, precio FROM tab_motos_cruiser WHERE referencia_cruiser='intruder'";
$result1= $conn->query($sql1);
               if ($result1->num_rows > 0) {
  while($row1 = $result1->fetch_assoc()) {
   $resultado1=$row1["referencia_cruiser"];
...
<section class="slider">
  <div>
    <img src="img/Cruiser/INTRUDER  GRIS.png">
    <div class="desc">
     <h2><?php echo $resultado1;?></h2>
      <p><?php echo  $simbolo.number_format($resultado2);?></p>
      <a href="/material1/proyecto_principal/info_motos_vendedor/info_cruiser_intruder.php" class="btn">Mas Informacion</a>
    </div>
  </div>
  <div>
    <img src="">
