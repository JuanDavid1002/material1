...
$stmt = $conn->prepare("CALL ingresar_motos_automaticas (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
$stmt->bind_param("ssssiisisssssssssssssssssssssssss", $referencia,$color,$modelo,$marca,$cantidad,$precio,$cilindraje,$clasificacionmotos,$transmision,
$motor,$sistemacombustible,$suspensiondelantera,$suspensiontrasera,$sistemavalvulas,$sistemaencendido,$diametropiston,$diametrocarrera,
$sistemaarranque,$relaccionreduccionfinal,$llantadelantera,$llantatrasera,$largo,$ancho,$distanciaejes,$frenodelantero,$frenotrasero,
$longitudtotal,$alturatotal,$anchuratotal,$distanciapiso,$pesoseco,$alturaasiento,$capacidadtanque);
...
$diametropiston=$_POST['txtdiametropiston'];
...
$anchuratotal=$_POST['txtanchuratotal'];
...
?>
 ...
 <input type="submit" name="select" class="btn btn-success btn-lg" value="Nuevo Registro" onclick="funcion(), location.href='formulario_motos_automaticas.html'"/>
