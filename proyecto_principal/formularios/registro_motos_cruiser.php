...
$stmt = $conn->prepare("CALL ingresar_motos_cruiser (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
$stmt->bind_param("ssssiisissssssssssssssss", $referencia,$color,$modelo,$marca,$cantidad,$precio,$cilindraje,$clasificacionmotos,$motor,
$potenciamaxima,$torque,$largo,$ancho,$altura,$distanciaejes,$distanciapiso,$alturaasiento,$pesoseco,$capacidadtanque,
$suspensionfrontal,$suspensiontrasera,$frenotrasero,$frenodelantero,$bateria);
...
<center>
<a href="formulario_motos_cruiser.html" class="btn btn-success btn-lg">Nuevo Registro</a>
