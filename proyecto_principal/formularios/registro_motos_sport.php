...
$stmt = $conn->prepare("CALL ingresar_motos_sport 
  (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
$stmt->bind_param("ssssiiissssssssssssssssssssssssiisssssssssiiissssss", $referencia,
$color,$modelo,$marca,$cantidad,$precio,$clasificacionmotos,$cilindraje,$transmision,$motor,$sistemaencendido,
$sistemacombustible,$diametrocarrera,$sistemaarranque,$frenodelantero,$frenotrasero,$desplazamiento,$torque,
$suspensiondelantera,$suspensiontrasera,$longitudtotal,$ancho,$largo,$alturatotal,$distanciapiso,$pesoseco,
$llantadelantera,$llantatrasera,$potenciamaxima,$patroncambio,$embrague,$relacioncomprension,$numerocilindros,
$distanciaejes,$suspensionfrontal,$sistemarefrigeracion,$sistemavalvulas,$carburador,$filtroaire,$bateria,
$luzdelantera,$sistemalubricacion,$capacidadascenso,$primaria,$relaccionreduccionfinal,$bujia,$reserva,
$aceitetransmision,$alturaasiento,$amortiguadortrasero,$capacidadtanque
);
...
$sistemaencendido=$_POST['txtsistemaencendido'];
...
$desplazamiento=$_POST['txtdesplazamiento'];
$torque=$_POST['txttorque'];
$suspensiondelantera=$_POST['txtsuspensiondelantera'];
$suspensiontrasera=$_POST['txtsuspensiontrasera'];
$longitudtotal=$_POST['txtlongitudtotal'];
$ancho=$_POST['txtancho'];
$largo=$_POST['txtlargo'];
$alturatotal=$_POST['txtalturatotal'];
...
$patroncambio=$_POST['txtpatroncambio'];
$embrague=$_POST['txtembrague'];
$relacioncomprension=$_POST['txtrelacioncomprension'];
$numerocilindros=$_POST['txtnumerocilindros'];
$distanciaejes=$_POST['txtdistanciaejes'];
$suspensionfrontal=$_POST['txtsuspensionfrontal'];
$sistemarefrigeracion=$_POST['txtsistemarefrigeracion'];
$sistemavalvulas=$_POST['txtsistemavalvulas'];
$carburador=$_POST['txtcarburador'];
$filtroaire=$_POST['txtfiltroaire'];
$bateria=$_POST['txtbateria'];
$luzdelantera=$_POST['txtluzdelantera'];
$sistemalubricacion=$_POST['txtsistemalubricacion'];
$capacidadascenso=$_POST['txtcapacidadascenso'];
$primaria=$_POST['txtprimaria'];
$relaccionreduccionfinal=$_POST['txtrelaccionreduccionfinal'];
$bujia=$_POST['txtbujia'];
$reserva=$_POST['txtreserva'];
$aceitetransmision=$_POST['txtaceitetransmision'];
$alturaasiento=$_POST['txtalturaasiento'];
$amortiguadortrasero=$_POST['txtamortiguadortrasero'];
...
<center>
<a href="formulario_motos_sport.html" class="btn btn-success btn-lg">Nuevo Registro</a>
