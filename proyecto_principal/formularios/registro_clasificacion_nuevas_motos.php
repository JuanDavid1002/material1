...
$stmt = $conn->prepare("CALL ingresar_clasificacion_motos (?)");
$stmt->bind_param("s", $clasificacionmotos);
...
<center>
<a href="formulario_clasificacion_motos.html" class="btn btn-success btn-lg">Nuevo Registro</a>
