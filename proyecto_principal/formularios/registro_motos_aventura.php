...
$stmt = $conn->prepare("CALL ingresar_motos_aventura (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,
    ?,?,?,?,?,?,?)");
$stmt->bind_param("ssssiisisssssssssssssssssssssss", $referencia,$color,$modelo,$marca,
$cantidad,$precio,$cilindraje,$clasificacionmotos,$transmision,$distanciaejes,$motor,
$suspensiondelantera,$suspensiontrasera,$largo,$ancho,$altura,$sistemavalvulas,$diametrocarrera,
$distanciapiso,$pesoseco,$sistemacombustible,$torque,$sistemaencendido,$potenciamaxima,
$alturaasiento,$llantadelantera,$llantatrasera,$frenodelantero,$frenotrasero,$suspensionfrontal,
...
$capacidadcombustible=$_POST['txtcapacidadcombustible'];
...
?>
 ...
 <input type="submit" name="select" class="btn btn-success btn-lg" value="Nuevo Registro" onclick="funcion(), location.href='formulario_motos_aventura.html'"/>
