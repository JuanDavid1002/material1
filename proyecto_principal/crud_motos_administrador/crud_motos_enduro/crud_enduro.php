...
$sql = "SELECT idmotosenduro,referencia_enduro,color_enduro,modelo_enduro,marca_enduro,totalmotos,precio,idclasificaciondemotos FROM tab_motos_enduro ORDER BY idmotosenduro";
            ...
            <div class="table-responsive">
              <table class="table">
                ...
                ?>
                  <tbody>
                    <tr>
                      <td><?php echo $row["referencia_enduro"]; ?></td>
                      <td><?php echo  $row["color_enduro"]; ?></td>
                      <td><?php echo  $row["modelo_enduro"]; ?></td>
                      <td><?php echo  $row["marca_enduro"]; ?></td>
                      ...
                      <td class="td-actions text-center">
                        ...
                        <a href="editar.php?id=<?php echo $row["idmotosenduro"]; ?>"><i class="material-icons">edit</i></a>
                        </button>

                        <td class="td-actions text-center">

                        <button type="button" class="btn btn-danger btn-round" data-toggle="modal" data-target="#staticBackdrop">
                        <a href="eliminar.php?id=<?php echo $row["idmotosenduro"]; ?>"id="borrar"><i class="material-icons">close</i></a>
                        </button>
                  </tbody>
                  </tr>
              <?php
