...
$sql = "SELECT idmotossport,referencia_sport,color_sport,modelo_sport,marca_sport,totalmotos,precio,idclasificaciondemotos FROM tab_motos_sport ORDER BY idmotossport";
              ...
              <div class="table-responsive">
                <table class="table">
                  ...
                  ?>
                    <tbody>
                      <tr>
                        <td><?php echo $row["referencia_sport"]; ?></td>
                        <td><?php echo  $row["color_sport"]; ?></td>
                        <td><?php echo  $row["modelo_sport"]; ?></td>
                        <td><?php echo  $row["marca_sport"]; ?></td>
                        ...
                        <td class="td-actions text-center">
                          ...
                          <button type="button" class="btn btn-success btn-round" data-toggle="modal" data-target="#staticBackdrop">
                            <a href="editar.php?id=<?php echo $row["idmotossport"]; ?>"><i class="material-icons">edit</i></a>
                          </button>

                        <td class="td-actions text-center">

                          <button type="button" class="btn btn-danger btn-round" data-toggle="modal" data-target="#staticBackdrop">
                            <a href="eliminar.php?id=<?php echo $row["idmotossport"]; ?>" id="borrar"><i class="material-icons">close</i></a>
                          </button>
