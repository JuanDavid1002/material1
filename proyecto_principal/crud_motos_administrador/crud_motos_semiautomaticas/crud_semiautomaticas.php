                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="td-actions text-center">
                        ...
                        <a href="editar.php?id=<?php echo $row["idmotossemiautomaticas"]; ?>"><i class="material-icons">edit</i></a>
                        </button>

                        <td class="td-actions text-center">

                        <button type="button" class="btn btn-danger btn-round" data-toggle="modal" data-target="#staticBackdrop">
                        <a href="eliminar.php?id=<?php echo $row["idmotossemiautomaticas"]; ?>"id="borrar"><i class="material-icons">close</i></a>
                        </button>
                  </tbody>
