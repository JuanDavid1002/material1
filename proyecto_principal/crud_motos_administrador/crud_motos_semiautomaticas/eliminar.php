...
$id=$_GET['id'];
$eliminar = "DELETE FROM tab_motos_semiautomaticas WHERE idmotossemiautomaticas='$id' ";
...
mysqli_close($conn);
    ...
    ?>
    <br>
    <button><a href="crud_semiautomaticas.php" class="btn btn-success">Realizar Otra Operacion</a>
    </button> 
 </body>
 </html>