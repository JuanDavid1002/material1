...
$simbolo="$";
$id = $_GET['id'];
$sql = "SELECT idmotoscruiser,referencia_cruiser,color_cruiser,modelo_cruiser,marca_cruiser,cantidad_cruiser,precio,idclasificaciondemotos FROM tab_motos_cruiser
WHERE idmotoscruiser='$id' ";
                    ...
                    <div class="container">
                      <div class="form-row">
                        <div class="col-md-6 mb-3">
                          ...
                          <input type="text" class="form-control" id="validationCustom01" value="<?php echo  $row["referencia_cruiser"]; ?>" name="txtreferencia" readonly>
                        ...
                        <div class="col-md-6 mb-3">
                          ...
                          <input type="text" class="form-control" id="validationCustom02" value="<?php echo  $row["color_cruiser"]; ?>" name="txtcolor">
                          <div class="valid-feedback">
                            ¡Campo Ok!
                          </div>
                          <div class="invalid-feedback">
                      ...
                      <div class="form-row">
                        <div class="col-md-6 mb-3">
                          ...
                          <input type="text" class="form-control" id="validationCustom01" value="<?php echo  $row["modelo_cruiser"]; ?>" name="txtmodelo">
                          <div class="valid-feedback">
                            ¡Campo Ok!
                          </div>
                          <div class="invalid-feedback">
                        ...
                        <div class="col-md-6 mb-3">
                          ...
                          <input type="text" class="form-control" id="validationCustom02" value="<?php echo  $row["marca_cruiser"]; ?>" name="txtmarca">
                          <div class="valid-feedback">
                            ¡Campo Ok!
                          </div>
                          <div class="invalid-feedback">
                      ...
                      <div class="form-row">
                        <div class="col-md-6 mb-3">
                          ...
                          <input type="text" class="form-control" id="validationCustom01" value="<?php echo  $row["cantidad_cruiser"]; ?>" name="txtcantidad">
                          <div class="valid-feedback">
                            ¡Campo Ok!
                          </div>
                          <div class="invalid-feedback">
                      ...
                      <input type="hidden" value="<?php echo  $row["idmotoscruiser"]; ?>" name="txtid">
                      <button type="submit" name="guardar" class="btn btn-success">Actualizar</button>
                      <a href="/material1/proyecto_principal/crud_motos_administrador/crud_motos_cruiser/crud_cruiser.php" class="btn btn-warning " role="button" aria-pressed="true">Regresar</a>
                </form>
            <?php
          }
        }
