...
$sql = "SELECT idmotoscruiser,referencia_cruiser,color_cruiser,modelo_cruiser,marca_cruiser,totalmotos,precio,idclasificaciondemotos FROM tab_motos_cruiser ORDER BY idmotoscruiser";
      ...
      <div class="col-md-8">
        <div class="card">
          <div class="card-header card-header-primary card-header-icon">
            ...
            <h4 class="card-title">Cruiser</h4>
          </div>
          <div class="card-body">
            <div class="table-responsive">
              <table class="table">
                ...
                ?>
                  <tbody>
                    <tr>
                      <td><?php echo $row["referencia_cruiser"]; ?></td>
                      <td><?php echo  $row["color_cruiser"]; ?></td>
                      <td><?php echo  $row["modelo_cruiser"]; ?></td>
                      <td><?php echo  $row["marca_cruiser"]; ?></td>
                      ...
                      <td class="td-actions text-center">
                        ...
                        <a href="editar.php?id=<?php echo $row["idmotoscruiser"]; ?>"><i class="material-icons">edit</i></a>
                        </button>

                        <td class="td-actions text-center">

                        <button type="button" class="btn btn-danger btn-round" data-toggle="modal" data-target="#staticBackdrop">
                        <a href="eliminar.php?id=<?php echo $row["idmotoscruiser"]; ?>"id="borrar"><i class="material-icons">close</i></a>
                        </button>
                  </tbody>
                  </tr>
              <?php
              ...
              <a href="/material1/template.php" class="btn btn-info " role="button" aria-pressed="true">Regresar</a>
