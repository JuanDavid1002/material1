...
$sql = "SELECT idmotosaventura,referencia_aventura,color_aventura,modelo_aventura,marca_aventura,totalmotos,precio,idclasificaciondemotos FROM tab_motos_aventura ORDER BY idmotosaventura";
            ...
            <div class="table-responsive">
              <table class="table">
                ...
                ?>
                  <tbody>
                    <tr>
                      <td><?php echo $row["referencia_aventura"]; ?></td>
                      <td><?php echo  $row["color_aventura"]; ?></td>
                      <td><?php echo  $row["modelo_aventura"]; ?></td>
                      <td><?php echo  $row["marca_aventura"]; ?></td>
                      ...
                      <td class="td-actions text-center">
                        ...
                        <a href="editar.php?id=<?php echo $row["idmotosaventura"]; ?>"><i class="material-icons">edit</i></a>
                        </button>

                        <td class="td-actions text-center">

                        <button type="button" class="btn btn-danger btn-round" data-toggle="modal" data-target="#staticBackdrop">
                        <a href="eliminar.php?id=<?php echo $row["idmotosaventura"]; ?>"id="borrar"><i class="material-icons">close</i></a>
                        </button>
                  </tbody>
                  </tr>
              <?php
