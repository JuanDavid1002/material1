...
WHERE idclasificacionusuarios=1 ORDER BY idusuarios";
...
?>
  ...
  <body>
    <video autoplay muted loop id="myVideo">
      <source src="https://player.vimeo.com/external/609115692.sd.mp4?s=33c0663f16d09f9d0264c88cb9281e16472b7af8&profile_id=164&oauth2_token_id=57447761" type="video/mp4">
                      ...
                      <tr>
                        ...
                        <td class="td-actions text-right">
                          ...
                          <button type="button" class="btn btn-success btn-round" data-toggle="modal" data-target="#staticBackdrop">
                            <a class="td-actions text-right" href="editar.php?id=<?php echo $row["idusuarios"]; ?>"><i class="material-icons">edit</i></a>
                          </button>
