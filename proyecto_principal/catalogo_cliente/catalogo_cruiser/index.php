...
$simbolo='$';
$consulta = "SELECT referencia_cruiser, 
color_cruiser, 
modelo_cruiser, 
precio, 
cilindraje_cruiser, 
        ...
        <div class="news-slider__item swiper-slide">
          <a href="#" class="news__item">
            <div class="news-date">
              ...
              <span class="news-date__txt">Cruiser</span>
            </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="was-validated" method="POST" action="mensajes5.php" >
              <form class="needs-validation " novalidate>
                ...
                <div class="form-group" class>
                  <label for="exampleFormControlSelect1">Tipo de Cruiser</label>
                  <select class="custom-select" required name="txttipos">
                    <option name="idtipos" value="">Seleccionar Tipo de Moto</option>
                    <option name="idtipos" value="intruder">intruder </option>
                  </select>
