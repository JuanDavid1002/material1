  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="was-validated" method="POST" action="mensajes6.php" >
              <form class="needs-validation " novalidate>
                ...
                <div class="form-group" class>
                  <label for="exampleFormControlSelect1">Tipo de Aventura</label>
                  <select class="custom-select" required name="txttipos">
                    <option name="idtipos" value="">Seleccionar Tipo de Moto</option>
                    <option name="idtipos" value="VStrom1050XT">VStrom1050XT </option>
                    <option name="idtipos" value="VStrom650XT">VStrom650XT</option>
                    <option name="idtipos" value="VStrom250">VStrom250</option>
                  </select>
