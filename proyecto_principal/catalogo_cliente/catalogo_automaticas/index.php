...
$simbolo='$';
$consulta = "SELECT   referencia_automaticas,
color_automaticas,
modelo_automaticas,
precio,
cilindraje_automaticas,
transmision_automaticas,
motor_automaticas,
capacidad_tanque_automaticas
FROM tab_motos_automaticas WHERE referencia_automaticas='Access 125 Fi'";
if ($resultado = $conn->query($consulta)) {
  ...
  $consulta2 = "SELECT   referencia_automaticas,
color_automaticas,
modelo_automaticas,
precio,
cilindraje_automaticas,
...
motor_automaticas,
capacidad_tanque_automaticas
FROM tab_motos_automaticas WHERE referencia_automaticas='Andress Fi'";
if ($resultado = $conn->query($consulta2)) {
  ...
  $consulta3 = "SELECT   referencia_automaticas,
color_automaticas,
modelo_automaticas,
precio,
cilindraje_automaticas,
...
motor_automaticas,
capacidad_tanque_automaticas
FROM tab_motos_automaticas WHERE referencia_automaticas='Burgman'";
      ...
      <div class="news-slider__wrp swiper-wrapper">
        <div class="news-slider__item swiper-slide">
          <a href="#" class="news__item">
            <div class="news-date">
              ...
              <span class="news-date__txt">Automaticas</span>
            </div>
            ...
            <div class="news__img">
              <img src="img/Automaticas/ACCESS 125 FI.png" alt="news">
            </div>
          </a>
        </div>
        ...
        <div class="news-slider__item swiper-slide">
          <a href="#" class="news__item">
            ...
            <div class="news__img">
              <img src="img/Automaticas/ADDRESS FI.png" alt="news">
            </div>
          </a>
        </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="was-validated" method="POST" action="mensajes1.php" >
              <form class="needs-validation " novalidate>
                ...
                <div class="form-group" class>
                  <label for="exampleFormControlSelect1">Tipo de Automaticas</label>
                  <select class="custom-select" required name="txttipos">
                    <option name="idtipos" value="">Seleccionar Tipo de Moto</option>
                    <option name="idtipos" value="Access 125 Fi">Access 125 Fi </option>
                    <option name="idtipos" value="Andress Fi">Andress Fi</option>
                    <option name="idtipos" value="Burgman">Burgman</option>
                  </select>
