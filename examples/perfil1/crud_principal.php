...
WHERE nombre_usuario='$nombres' and idclasificacionusuarios='$cliente' ";
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                <a href="/material1/cliente.php" class="btn btn-danger " role="button" aria-pressed="true">Regresar</a>
      </center>
    </body>
